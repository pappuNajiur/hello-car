...
class Tank_auth
{
	 ...
	 * @return	array
	 */
	function create_user($username,$email,$password,$email_activation,$firstname,$lastname,$address,$mobile,$user_type)
	{
		if ((strlen($username) > 0) AND !$this->ci->users->is_username_available($username)) {
			...
			if (!is_null($res = $this->ci->users->create_user($data, !$email_activation))) {
				//$this->users->UpdateProfileInfo($firstname["firstname"],$lastname["lastname"],$address['address'],$mobile['mobile'],$user_type['user_type']);
