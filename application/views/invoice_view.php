...
<div id="main_invoice" style="margin: 0 auto;width: 800px;">
	...
	<div id="invoice" style="margin: 0 auto;min-height: 1100px;width: 743px;">
		<div id="shop_title_box" style="background-color: lightgray;float: left;height: auto;margin-bottom: 0;margin-left: 0px;margin-right: 0;margin-top: 0;text-align: right;width: 100%;">			
			<div id="shop_title_test" style="background:#C0C4C0;color: black;float: left;font-family: 'Times New Roman';font-size: 24px;font-weight: normal;height: 50%;margin-bottom: 0;margin-right: 0;margin-top: 0;text-align: center;width: 100%;"> Hello Car </div>
			<div id="shop_address_test" style="    color: black;float: left;font-family: arial;font-size: 13px;font-weight: normal;height: 16px;margin-bottom: 0;margin-right: 0;margin-top: 0;text-align: center;width: 100%;"> Metropolitan University, <br>Bateshwar,Sylhet . </div>			
			<div id="shop_title_test"  style="background:#C0C4C0;color: black;float: left;font-family: 'Times New Roman';font-size: 24px;font-weight: normal;height: 50%;margin-bottom: 0;margin-right: 0;margin-top: 0;text-align: center;width: 100%;"> Invoice </div>
		...
		<div id="transaction_details" style="float: left;margin-top: 5px;min-height: 110px;width: 743px;min-height:170px;">
			...
			<div id="t_right" style="~background: none repeat scroll 0 0 green;float: left;min-height: 105px;width: 291px;"> 
				...
				<div id="ri8_portion" style="~background: none repeat scroll 0 0 brown;float: left;min-height: 100px;width: 102px;">
					...
					<div class="title_result" style="~background: none repeat scroll 0 0 red;float: left;font-family: arial;font-size: 13px;line-height: 20px;margin: 5px 0 0;min-height: 20px;text-align: right;text-indent: 5px;width: 101px;">
						<big style="font-size: 11px; font-weight:bold;"> BDT </big> <?php echo $row->paid_amount;?>						
					</div>
		...
		<div id="signature_area" style="height:55px;float:left;margin:0px  auto;">	
			...
			<div id="signature_one"  style="float: left;height: 25px;width: 371px;"> 
				<div class="customer_signature2" style="line-height:25px;~width:350 px;height:25px;font-size:13px;margin-left:165px;border-bottom:1px solid  gray;text-align:center;min-width:190px;"> On behalf of Hello Car </div>
			</div>
