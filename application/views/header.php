...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <?php
      if($this->tank_auth->get_user_type() == 'admin'){
        $link = base_url().'Admin_controller/index';
      }
      else if($this->tank_auth->get_user_type() == 'customer'){
          $link = base_url().'Admin_controller/index';
      }
      else if($this->tank_auth->get_user_type() == 'driver'){
          $link = base_url().'Admin_controller/index';
      }
      else{
        $link = base_url().'Admin_controller/index';
  ...
  <?php }
      ...
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>Driver</b></span>
    </a>
    <?php }
    else{ ?>
           <a href="<?php echo $link;?>" class="logo">
      <!-- mini logo for sidebar mini 50x50 pixels -->
      <span class="logo-mini"><b>C</span>
      <!-- logo for regular state and mobile devices -->
          ...
          <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-footer">
                <div class="pull-left">
                  <a href="<?php echo base_url();?>Admin_controller/edit_customers/<?php echo $this->tank_auth->get_user_id();?>" class="btn btn-default btn-flat">Profile</a>
                </div>
