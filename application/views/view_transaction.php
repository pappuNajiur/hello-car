    ...
    <!-- Content Header (Page header) -->
      ...
      <div class="row">
        ...
        <section class="col-lg-12 connectedSortable">
          ...
          <CENTER><h3 style="color:black; margin: 0px;">All Unverified Transaction</h3></CENTER><br>
           ...
           <th style="color:black; font-size:15px;">Paid Amount</th>
            <th style="color:black; font-size:15px;">Trnsaction ID</th>
             ...
             <th style="color:black; font-size:15px;">Transaction Date</th>
              <th style="color:black; font-size:15px;"><a href="#">Verify Payment</a></th>
      </tr>
    ...
    <tbody>
        ...
        <?php
         ...
         {  
           ...
           <td>  
				<a href="#" class="btn btn-info btn-sm verify" data-value="<?php echo $row->transaction_id;?>"> Verify</a>
				<a href="#" class="btn btn-info btn-sm wrong_info" data-value="<?php echo $row->transaction_id;?>"> Wrong Info</a>
		   </td>    
