           	...
           	<div class="container box_1620">
           		<div class="banner_inner d-flex align-items-center">
					<div class="banner_content">
						<div class="media">
							<div class="d-flex">
								<img style="width:370px; height:300px;" src="<?php echo base_url();?>assets/image_path/muza.jpg" alt="">
							</div>
							<div class="media-body">
								<div class="personal_text">
									...
									<ul class="list basic_info">
										<li><a><i class="lnr lnr-phone-handset"></i> 01728 366119</a></li>
										<li><a ><i class="lnr lnr-envelope"></i> rabeyabegum066@gmail.com</a></li>
