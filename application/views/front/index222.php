<?php include("inc/header.php");?>
			...
			<div class="slider_wrapper ">
				<div id="camera_wrap" class="">
					<div data-src="<?php echo base_url();?>assets/frontcss/images/slide.jpg" ></div>
					<div data-src="<?php echo base_url();?>assets/frontcss/images/slide1.jpg" ></div>
					<div data-src="<?php echo base_url();?>assets/frontcss/images/slide2.jpg"></div>
				</div>
			</div>
