...
<!--==============================Content=================================-->
				...
				<div class="container_12">
					...
					<div class="gallery">
						<div class="grid_4"><a href="<?php echo base_url();?>" class="gal"><img src="<?php echo base_url();?>assets/frontcss/images/page3_img1.jpg" alt=""></a>
							<a href="<?php echo base_url();?>auth/login?rdr=1<?php //echo $row->vehicle_id;?>" class="button">Book Now</a>
						</div>
								...
								<div class="box-footer no-padding">
								  <ul class="nav nav-stacked">
								   <!-- <li><a href="#">Projects <span class="pull-right badge bg-blue">31</span></a></li>-->
									<li><a class="nedd_car" data-value="<?php echo $row->vehicle_id;?>" href="<?php echo base_url();?>auth/login?rdr=<?php echo $row->vehicle_id;?>">Need A Ride ? <span class="pull-right badge bg-aqua">Book Now</span></a></li>
          ...
          <h2 class="page-header">All Vehicles</h2>
