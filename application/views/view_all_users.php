  ...
  <div class="content-wrapper">
      ...
      <div class="row">
        ...
        <section class="col-lg-12 connectedSortable">
          ...
          <div class="box">
            <div class="box-header">
              <CENTER><h3 style="color:black;">All Users Info</h3></CENTER><br>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
		...
		<tr>  
          ...
          <a onclick="return confirm('Are you sure to Edit ?');" href="<?php echo base_url();?>Admin_controller/edit_users/<?php echo $row->id;?>"><i class="fa fa-pencil"style="font-size:18px;color:blue"></i></a> ||
            
            <a onclick="return confirm('Are you sure to Ban?');" href="<?php echo base_url();?>Admin_controller/ban_users/<?php echo $row->id;?>"><i  class="fa fa-ban" style="font-size:18px;color:red"></i></a>
  ...
  <script>  
      $(document).ready(function(){  
           $('.delete_data').click(function(){  
                ...
                {  
                     window.location="<?php echo base_url(); ?>Admin_controller/delete_users/"+user_id;  
                }  
                else  
                {  
                     return false;  
