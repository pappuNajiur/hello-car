    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <a href="#">
            <i class="fa fa-edit"></i> <span>Setup Area</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
            <?php } ?>
        ...
        <li class="treeview">
          ...
          <a href="#">
            <i class="fa fa-edit"></i> <span>Rent Area</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
            <?php } ?>
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="<?php echo base_url();?>My_controller/ordercar"><i class="fa fa-circle-o"></i>Order a Car </a></li>
            <li><a href="<?php echo base_url();?>Admin_controller/displayallorder"><i class="fa fa-circle-o"></i>My orders</a></li>
